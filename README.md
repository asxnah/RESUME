...
### About me 
Proficient with React hooks (useState, useEffect, useMemo, useCallback, useContext), JavaScript async fundamentals, component lifecycle principles, and virtual DOM behavior. Experienced with Next.js App Router, Pages Router, and Server Components (RSC). Skilled in integrating frontend with backend services built on NestJS, including working with DTOs.
...
- Built modular UI architecture: separated common components, structured project in app/components.
- Configured Redux Toolkit: store, rootReducer, slices, CRUD operations, strict typing of state and actions.
- Integrated frontend with NestJS backend (REST API, DTOs, controllers).
- Applied optimization techniques: lazy loading, code splitting.
- Worked with TypeScript: interfaces, component props typing, async functions, DTOs.
- Styled UI with Tailwind CSS and CSS Modules.
- Set up team development processes: GitHub Flow, ESLint/Prettier, Turbopack.
...
#### Fullstack Developer, February 2025 — June 2025 (5 months), Graduation Thesis Project github.com/asxnah/nori
...
#### Fullstack Developer, October 2024 — December 2024 (3 months), Vega LLC
...
#### Front-end Developer, March 2024 — May 2024 (3 months), Somaks LLC
...
#### Stack
Next.js (App Router, Pages Router, Server Components), Redux Toolkit (store, slices, CRUD, typing), NestJS (integration, DTOs), Turbopack, CSS Modules, Rendering optimization, virtual DOM, lazy loading, code splitting, TypeScript/JavaScript, HTML5, CSS3, PHP, PHP Composer, VueJS, ReactJS, NextJS, Redux, Zustand, Tailwind, MongoDB, MySQL, Bootstrap, REST API, Node.js, Git, GitHub, Figma, Responsive design, BEM, OOP
...
### Обо мне
Уверенно работаю с хуками React (useState, useEffect, useMemo, useCallback, useContext). Понимаю основы асинхронности JavaScript, принципы жизненного цикла компонентов, рендеринга и виртуального DOM. Имею опыт работы с App Router и Pages Router в Next.js, а также с серверными компонентами (RSC). Умею интегрировать frontend с backend на NestJS.
...
- Построила модульную архитектуру интерфейса, выделила общие UI-компоненты и структуру в app/components.
- Настроила Redux Toolkit: store, rootReducer, слайсы, CRUD-операции, строгую типизацию состояния и экшенов.
- Интегрировала frontend с backend-частью на NestJS (REST API, DTO, контроллеры).
- Использовала оптимизации: lazy loading, code splitting.
- Работала с TypeScript: интерфейсы, типизация компонентов, асинхронных функций и DTO.
- Верстала с использованием Tailwind CSS и CSS Modules.
...
#### Fullstack разработчик, Февраль 2025 — Июнь 2025 5 месяцев, Выпускная дипломная работа github.com/asxnah/nori
...
#### Fullstack разработчик, Октябрь 2024 — Декабрь 2024 3 месяца, ООО "Вега"
...
- Настроила Composer.
- Реализовала конфигурационный файл config.php для централизованного управления параметрами окружения (подключение к БД, общие настройки сайта).
...
#### Fullstack разработчик, Март 2024 — Май 2024 3 месяца, ООО "Сомакс"
...
#### Стек
Next (App Router, Pages Router, Server Components), Redux Toolkit, NestJS, Turbopack, CSS Modules, Оптимизация рендеринга, виртуальный DOM, lazy loading, code splitting, TypeScript/JavaScript, HTML5, CSS3, PHP, PHP Composer, VueJS, ReactJS, NextJS, Redux, Zustand, Tailwind, MongoDB, MySQL, Bootstrap, REST API, Node.js, Git, GitHub, Figma, Адаптивная верстка, BEM, ООП
